...
// import { COMPANY_DETAILS } from '../';
import { COMPANY_DETAILS } from '@/app/locations/prayagraj/website-development/constants';
    ...
    <section id="contact" className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            <div>
              <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Connect With Us</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-2">
                Visit Our Prayagraj Development Center
              </h2>
              <p className="text-slate-400 text-sm sm:text-base mt-4 leading-relaxed">
                Have a new project or want to upgrade your business website in Prayagraj or Allahabad? Stop by our office in Civil Lines or get in touch for a instant project blueprint and quotation.
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">{COMPANY_DETAILS.phone} / +91-9336289192</p>
                </div>
              </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hello%20Codelura,%20I%20want%20to%20schedule%20a%20meeting%20in%20Civil%20Lines.`}
                target="_blank"
          ...
          {/* Right Side: Reusable Google Map Component */}
          <motion.div
          ...
          >
            <GoogleMap
              ...
              title="Codelura Tech Center - Prayagraj Location"
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl flex items-center justify-between gap-4">
              <div>
                <div className="text-white font-bold text-sm">Schedule an Office Consultation</div>
