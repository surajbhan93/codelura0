...
import { SERVICES_LIST } from '@/app/locations/prayagraj/website-development/constants';
import {
  Building2,
  Globe,
  Zap,
    ...
    <section id="services" className="py-20 bg-slate-900/30 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">End-To-End Engineering</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Custom Website Development Services in Prayagraj
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            Whether you need a high-converting landing page, a WordPress site, a custom Next.js portal, or a Shopify e-commerce store, Codelura provides tailored web engineering for Prayagraj businesses.
          </p>
        </div>
