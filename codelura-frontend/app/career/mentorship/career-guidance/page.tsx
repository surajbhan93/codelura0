// app/career/jobs/premium/career-guidance/page.tsx
...
// ============================================
async function getCareerGuidancePlans() {
  try {
    ...
    // ✅ Filter for career-guidance category (no duplicate conditions)
    return plans.filter(
      (plan: PremiumPlan) =>
        plan.category === "career-guidance" || plan.category === "career-guidance"
    );
  } catch (error) {
    console.error("Error fetching career guidance plans:", error);
    return [];
  }
}
...
// ─── Career Guidance Plan Card ───
const CareerGuidancePlanCard = ({ plan }: { plan: PremiumPlan }) => {
  ...
  return (
    ...
    >
      ...
      <Link
        href={`/career/mentorship/career-guidance/${plan.slug}`}
...
const TESTIMONIALS = [
  {
    ...
    text: "The guidance session gave me total clarity on my next move. My mentor helped me identify the right skills to build and the right roles to target. Landed my dream role within 4 months!",
    rating: 5,
    industry: "Technology",
  },
  {
    ...
    text: "I was stuck in my career for 2 years. One session gave me the clarity I needed. The industry-specific roadmap was exactly what I was looking for. Worth every rupee.",
    rating: 5,
    industry: "Consulting",
  },
  {
    ...
    text: "The guidance helped me understand what leadership roles actually require. The roadmap and honest feedback made all the difference. Got promoted within 3 months!",
    rating: 5,
    industry: "Design",
  },
];
...
const FAQS = [
  {
    q: "Which career guidance plan should I choose?",
    a: "If you need quick clarity on one specific decision (which industry, which role, how to switch), go with the starter plan. If you want ongoing support while executing a career plan over time, choose the growth plan. For senior roles and leadership positions, the advanced plan is your best bet.",
  },
  {
  ...
  },
  {
    ...
    a: "Absolutely! If you start with a smaller plan and want to continue with a deeper one, just reach out to our support team. We'll adjust the difference seamlessly.",
  },
  {
...
export default async function CareerGuidancePage() {
  const plans = await getCareerGuidancePlans();
      ...
      <section className="relative overflow-hidden bg-[#1a1208] px-6 py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-base font-light leading-relaxed text-slate-300 sm:text-lg">
            Get a clear, industry-specific roadmap from a verified professional — realistic salary
            expectations, the right next steps, and honest answers to your biggest career questions.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-3xl font-bold text-slate-900 sm:text-4xl">
              Pick the Right <span className="text-amber-600">Career Guidance Plan</span>
            </h2>
            <p className="mt-2 text-slate-600">
              Each plan is designed for a different level of depth and support
            </p>
          </div>
            ...
            {plans.length === 0 ? (
              <div className="rounded-2xl border border-slate-200 bg-white p-12 text-center">
                ...
                <h3 className="mb-2 text-xl font-bold text-slate-900">
                  No Career Guidance Plans Available
                </h3>
                <p className="text-slate-500">
                  We&apos;re preparing new guidance packages for you. Check back soon!
                </p>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                {plans.map((plan) => (
                  <CareerGuidancePlanCard key={plan._id} plan={plan} />
                ))}
              </div>
            )}
          </Suspense>
      ...
      <section className="bg-gradient-to-r from-amber-600 to-orange-600 px-6 py-16">
        <div className="mx-auto max-w-3xl text-center text-white">
          ...
          <p className="mt-2 text-amber-100">
            Book your career guidance session today and get expert direction.
          </p>
          <Link
