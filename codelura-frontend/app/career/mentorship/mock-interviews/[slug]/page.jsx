...
async function getPlan(slug) {
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/premium/plan/${slug}`, {
      // const res = await fetch(`https://career.codelura.com/api/premium/plan/${slug}`, {
  ...
  <div className="flex items-start gap-4">
    ...
    <div>
      <h3 className="text-base font-semibold text-amber-900">
        Payment Failed? or any other 
      </h3>

      <p className="mt-2 text-sm text-gray-600">
        If your payment was unsuccessful or you encountered any issue during checkout,
        please fill out the support form. Our team will verify your request and help
        you schedule your Mock Interview as soon as possible.
      </p>
      ...
      <a
        ...
        className="mt-4 inline-flex items-center gap-2 rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-amber-600 hover:shadow-md"
      >
        📝 Fill Support Form
      </a>
    </div>
