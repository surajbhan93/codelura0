...
export function generateSchemas() {
  ...
  const localBusinessSchema = {
    ...
    '@id': 'https://codelura.com/locations/prayagraj/app-development/#localbusiness',
    name: `${COMPANY_DETAILS.name} - App Development Company in Prayagraj`,
    url: 'https://codelura.com/locations/prayagraj/app-development',
    logo: 'https://codelura.com/logo.png',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'Mobile App Development Services in Prayagraj',
    provider: {
      '@type': 'LocalBusiness',
      name: COMPANY_DETAILS.name
    },
    ...
    description:
      'Custom Android and iOS mobile app development, Flutter & React Native cross-platform engineering, App Store publishing, and enterprise mobile solutions in Prayagraj (Allahabad).',
    offers: {
      '@type': 'Offer',
      priceCurrency: 'INR',
      price: '24999',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 4,
        name: 'App Development Company in Prayagraj',
        item: 'https://codelura.com/locations/prayagraj/app-development'
      }
    ]
  };
