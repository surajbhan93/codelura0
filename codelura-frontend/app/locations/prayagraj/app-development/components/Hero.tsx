        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-cyan-500/30 text-cyan-300 text-xs sm:text-sm font-medium shadow-sm">
              ...
              <span>Premier Mobile App Development Agency in Prayagraj (Allahabad)</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.12]">
              Top <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400">App Development Company</span> in Prayagraj
            </h1>

            <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-normal">
              Transform your business with high-performance <strong className="text-white">Android, iOS, Flutter &amp; React Native</strong> mobile applications. Codelura engineers secure, fast, and scalable mobile apps for coaching centers, hospitals, real estate agencies, e-commerce stores, and startups in <strong className="text-cyan-400">Civil Lines, Katra, George Town &amp; Naini</strong>.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs sm:text-sm text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span>60fps Smooth Native &amp; Flutter Apps</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
              ...
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Razorpay UPI &amp; Mobile Payments Included</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>App Store Optimization (ASO) Ready</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              >
                <span>Get Free App Quote &amp; Demo</span>
                <ArrowRight className="w-5 h-5" />
              </a>

              <a
                href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hi%20Codelura,%20I%20want%20to%20discuss%20a%20mobile%20app%20development%20project%20in%20Prayagraj.`}
                target="_blank"
              ...
              >
                ...
                <span>WhatsApp App Architect</span>
              </a>
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-slate-800 bg-slate-900 p-2 shadow-2xl shadow-cyan-500/10">
              <Image
                src={images.hero}
                alt="App Development Company in Prayagraj - Codelura Mobile Lab"
                width={800}
                height={600}
                priority
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-slate-950/90 backdrop-blur-md p-4 rounded-xl border border-slate-800/80">
                <div className="flex items-center justify-between text-xs">
                  <div>
                    <span className="text-white font-bold block">Prayagraj Mobile App Lab</span>
