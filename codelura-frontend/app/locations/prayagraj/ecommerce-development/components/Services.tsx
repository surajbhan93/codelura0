    ...
    <section id="services" className="py-20 bg-slate-900/30 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">End-to-End Online Retail</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Custom Ecommerce Website Development Services in Prayagraj
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            From bespoke full-stack Next.js 15 platforms and WooCommerce stores to Shopify OS 2.0, multi-vendor marketplaces, and B2B wholesale portals.
          </p>
        </div>
          ...
          {SERVICES_LIST.map((service, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>Request Custom E-Commerce Blueprint</span>
