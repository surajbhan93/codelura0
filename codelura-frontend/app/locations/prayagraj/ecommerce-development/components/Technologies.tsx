      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          <div className="lg:col-span-7 space-y-4">
            <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">E-Commerce Tech Stack</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
              Cutting-Edge E-Commerce Engines &amp; APIs We Master
            </h2>
            <p className="text-slate-400 text-base leading-relaxed">
              We engineer custom e-commerce platforms using Next.js 15, React 19, WooCommerce, Shopify OS 2.0, Node.js, PostgreSQL, Razorpay UPI, Shiprocket, and Cloudflare CDN.
            </p>
          </div>
          <div className="lg:col-span-5">
            <div className="rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 p-2 shadow-xl">
              <Image
                ...
                alt="E-Commerce Stack - Next.js 15, WooCommerce, Shopify, Node.js, Razorpay, Shiprocket"
                width={600}
                height={400}
                loading="lazy"
