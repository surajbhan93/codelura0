    ...
    <section className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Sector Specific E-Commerce</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Industries We Build E-Commerce Platforms For in Prayagraj &amp; Allahabad
          </h2>
          <p className="text-slate-400 text-base">
            From Chowk saree handloom portals to Katra academic book storefronts and Naini B2B wholesale platforms, we build tailored e-commerce platforms.
          </p>
        </div>
