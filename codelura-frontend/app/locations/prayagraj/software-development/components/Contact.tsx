    ...
    <section id="contact" className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            <div>
              <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Free Software Consultation</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mt-2">
                Visit Our Prayagraj Software Tech Center
              </h2>
              <p className="text-slate-400 text-sm sm:text-base mt-4 leading-relaxed">
                Have a complex software project or want to automate your business workflows in Prayagraj or Allahabad? Stop by our Civil Lines office or schedule a consultation with our senior software architects.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <a
                href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hello%20Codelura,%20I%20want%20to%20schedule%20a%20custom%20software%20consultation%20in%20Civil%20Lines.`}
                target="_blank"
          ...
          >
            <GoogleMap
              ...
              title="Codelura Software Hub - Prayagraj Location"
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl flex items-center justify-between gap-4">
              <div>
                <div className="text-white font-bold text-sm">Schedule a 1-on-1 Software Architecture Demo</div>
