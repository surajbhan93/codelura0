      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          <div className="lg:col-span-7 space-y-4">
            <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Shopify Tech Stack</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
              Cutting-Edge E-Commerce Frameworks &amp; APIs We Master
            </h2>
            <p className="text-slate-400 text-base leading-relaxed">
              We engineer high-converting storefronts utilizing Shopify OS 2.0, Liquid, GraphQL Storefront API, Next.js 15, Razorpay UPI, Shiprocket logistics, and Cloudflare Edge CDN.
            </p>
          </div>
          <div className="lg:col-span-5">
            <div className="rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 p-2 shadow-xl">
              <Image
                ...
                alt="Shopify Stack - Liquid, OS 2.0, GraphQL API, Next.js 15, Razorpay, Shiprocket"
                width={600}
                height={400}
                loading="lazy"
