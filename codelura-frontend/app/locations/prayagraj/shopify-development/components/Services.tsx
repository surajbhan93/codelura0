      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Custom Shopify Development Services in Prayagraj
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            From bespoke Liquid OS 2.0 theme development and Headless Next.js storefronts to platform migrations, 1-click UPI checkout, and automated shipping.
          </p>
        </div>
          ...
          {SERVICES_LIST.map((service, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span>Request Store Blueprint</span>
