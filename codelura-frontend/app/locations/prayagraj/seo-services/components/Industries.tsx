    ...
    <section className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Sector Specific SEO</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Industries We Help Rank #1 in Prayagraj &amp; Allahabad
          </h2>
          <p className="text-slate-400 text-base">
            From educational coaching hubs in Katra to medical polyclinics in George Town, we deliver specialized organic search campaigns for local Prayagraj sectors.
          </p>
        </div>
