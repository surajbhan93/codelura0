        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-cyan-500/30 text-cyan-300 text-xs sm:text-sm font-medium shadow-sm">
              ...
              <span>Top Rated Local SEO &amp; Search Agency in Prayagraj (Allahabad)</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.12]">
              Best <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400">SEO Company in Prayagraj</span> for #1 Google Rankings
            </h1>

            <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-normal">
              Dominate organic Google search results, Google Maps 3-Pack, and Google AI Overviews. Codelura provides data-driven <strong className="text-white">Local SEO, Technical SEO, On-Page &amp; Off-Page SEO</strong> for coaching centers, medical clinics, real estate, and local businesses in <strong className="text-cyan-400">Civil Lines, Katra, George Town &amp; Naini</strong>.
            </p>

            {/* Quick SEO Benefits Bullet Points */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 text-xs sm:text-sm text-slate-300">
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>#1 Google Maps 3-Pack Local Domination</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>AI &amp; Entity SEO (Google AI Overviews Ready)</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Technical Core Web Vitals Optimization</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>100% White-Hat High Authority Backlinks</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <a
                href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hi%20Codelura,%20I%20want%20a%20free%20SEO%20audit%20for%20my%20business%20in%20Prayagraj.`}
                target="_blank"
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-slate-800 bg-slate-900 p-2 shadow-2xl shadow-cyan-500/10">
              <Image
                src={images.hero}
                alt="SEO Company in Prayagraj - Codelura Tech Center"
                width={800}
                height={600}
                priority
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-slate-950/90 backdrop-blur-md p-4 rounded-xl border border-slate-800/80">
                <div className="flex items-center justify-between text-xs">
                  <div>
                    <span className="text-white font-bold block">Prayagraj SEO Command Center</span>
