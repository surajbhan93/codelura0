...
export function generateSchemas() {
  ...
  const localBusinessSchema = {
    ...
    '@id': 'https://codelura.com/locations/prayagraj/seo-services/#localbusiness',
    name: `${COMPANY_DETAILS.name} - SEO Company in Prayagraj`,
    url: 'https://codelura.com/locations/prayagraj/seo-services',
    logo: 'https://codelura.com/logo.png',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'SEO Services in Prayagraj',
    provider: {
      '@type': 'LocalBusiness',
      name: COMPANY_DETAILS.name
    },
    ...
    description:
      'Comprehensive search engine optimization (SEO) services, Google Maps 3-Pack ranking, Technical SEO, On-Page & Off-Page SEO, and AI GEO/AEO search optimization for Prayagraj (Allahabad) businesses.',
    offers: {
      '@type': 'Offer',
      priceCurrency: 'INR',
      price: '7999',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        '@type': 'ListItem',
        position: 4,
        name: 'SEO Company in Prayagraj',
        item: 'https://codelura.com/locations/prayagraj/seo-services'
      }
    ]
  };
