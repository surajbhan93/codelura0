    ...
    <section id="services" className="py-20 bg-slate-900/30 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Performance Digital Growth</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Digital Marketing Services in Prayagraj
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            From Google Ads (PPC) and Meta Ads (Facebook &amp; Instagram) to Local SEO, coaching lead generation, WhatsApp automation, and YouTube marketing.
          </p>
        </div>
