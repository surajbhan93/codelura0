    ...
    <section id="faqs" className="py-20 bg-slate-900/30 border-b border-slate-800/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Marketing FAQs</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Frequently Asked Questions (FAQs) - Digital Marketing Prayagraj
          </h2>
          <p className="text-slate-400 text-base">
            Everything you need to know about Google Ads, Meta Lead Ads, Local SEO, WhatsApp automation, CPL optimization, and transparent ROI reporting in Prayagraj.
          </p>
        </div>
