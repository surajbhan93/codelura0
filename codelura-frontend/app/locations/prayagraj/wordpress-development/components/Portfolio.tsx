    ...
    <section className="py-20 bg-slate-900/20 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">WordPress Case Studies</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Featured Prayagraj WordPress &amp; WooCommerce Case Studies
          </h2>
          <p className="text-slate-400 text-base">
            Explore how Codelura engineered custom WordPress websites for coaching institutes, clinics, real estate builders, and WooCommerce sellers in Prayagraj.
          </p>
        </div>
          ...
          {PORTFOLIO.map((item, idx) => (
            ...
            >
              <div className="relative h-64 w-full bg-slate-950">
                <Image
                  src={item.imageUrl}
                  alt={`${item.title} - Custom WordPress Development Project in Prayagraj`}
                  fill
