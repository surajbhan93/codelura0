  ...
  return (
    <section className="py-20 bg-slate-950 border-b border-slate-800/80 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-15 pointer-events-none">
        <Image
          src={images.cta}
          alt="Codelura Prayagraj WordPress Development CTA Background"
          fill
          sizes="100vw"
          loading="lazy"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Fast &amp; Easy CMS Solutions</span>
          <h2 className="text-3xl sm:text-5xl font-black text-white leading-tight">
            Ready to Build a High-Speed WordPress Website in Prayagraj?
          </h2>
          <p className="text-slate-300 text-base sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Get a free website audit, custom design blueprint, and explicit price quote today. Partner with Codelura — Prayagraj's top custom WordPress agency.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <a
              href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hi%20Codelura,%20I%20want%20to%20build%20a%20WordPress%20website%20for%20my%20Prayagraj%20business.`}
              target="_blank"
        ...
        <div className="bg-slate-900/60 border border-slate-800 p-8 rounded-3xl space-y-6">
          <div className="flex items-center gap-2 text-white font-bold text-lg">
            ...
            <span>Target Localities We Serve for WordPress Development in Prayagraj</span>
          </div>
