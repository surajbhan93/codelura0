    ...
    <section id="services" className="py-20 bg-slate-900/30 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Custom CMS Solutions</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Custom WordPress Development Services in Prayagraj
          </h2>
          <p className="text-slate-400 text-base sm:text-lg">
            From bespoke custom Gutenberg themes and WooCommerce online stores to PageSpeed optimization, malware cleanup, and 24/7 SLA maintenance.
          </p>
        </div>
