...
export function generateSchemas() {
  ...
  const localBusinessSchema = {
    ...
    '@id': 'https://codelura.com/locations/gurugram/software-development/#localbusiness',
    name: `${COMPANY_DETAILS.name} - Software Development Company in Gurugram`,
    url: 'https://codelura.com/locations/gurugram/software-development',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'Enterprise Software & SaaS Development Services in Gurugram',
    provider: { '@type': 'LocalBusiness', name: COMPANY_DETAILS.name },
    areaServed: { '@type': 'City', name: 'Gurugram' },
    description: 'Custom Enterprise ERP, CRM software, multi-tenant SaaS engineering, business automation, and cloud microservices in Gurugram (Gurgaon).'
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'Software Development Company in Gurugram', item: 'https://codelura.com/locations/gurugram/software-development' }
    ]
  };
