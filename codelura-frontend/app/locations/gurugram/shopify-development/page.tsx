...
import { gurugramShopifyDevMetadata } from './metadata';
...
export const metadata: Metadata = gurugramShopifyDevMetadata;

export default function GurugramShopifyDevelopmentPage() {
  const {
    organizationSchema,
    localBusinessSchema,
    serviceSchema,
    ...
    <main className="bg-slate-950 text-slate-100 font-sans min-h-screen selection:bg-cyan-500 selection:text-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 text-slate-300 leading-relaxed text-base sm:text-lg">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
              The Definitive Shopify &amp; D2C Store Development Guide for Brands in Gurugram
            </h2>
            <p className="text-slate-400">
              D2C consumer brands in Gurugram need fast loading, conversion-optimized Shopify stores that deliver high sales return. Whether you operate a luxury fashion apparel brand on <strong className="text-white">Golf Course Road</strong>, a retail business on <strong className="text-white">MG Road</strong>, or a lifestyle brand in <strong className="text-white">Cyber City</strong>, Codelura Technologies engineers custom Shopify OS 2.0 stores, Headless Shopify portals, custom Liquid themes, and payment app integrations.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border border-cyan-500/30 p-8 rounded-3xl text-center space-y-4">
            <h4 className="text-xl sm:text-2xl font-bold text-white">Ready to Build or Migrate Your Shopify Store in Gurugram?</h4>
            <p className="text-sm text-slate-300 max-w-2xl mx-auto">
              Our Gurugram Shopify engineering team will audit your storefront design, optimize Liquid code performance, and integrate 1-click Razorpay UPI payments.
            </p>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-10 text-slate-500 text-xs text-center space-y-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-400">
          <div>&copy; {new Date().getFullYear()} <strong className="text-white">Codelura Technologies</strong>. All rights reserved. Top Shopify Development Company in Gurugram &amp; Gurgaon, Haryana.</div>
