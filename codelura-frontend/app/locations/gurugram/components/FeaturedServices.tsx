...
import { GURUGRAM_SERVICES } from '../constants';
    ...
    <section className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">IT &amp; Digital Services in Gurugram</span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Software Development &amp; Digital Engineering Services
          </h2>
          <p className="text-slate-400 text-sm sm:text-base">
            From enterprise SaaS applications and mobile apps to AEO, SEO, and GEO search rankings — Codelura Technologies delivers end-to-end digital solutions in Gurugram (Gurgaon).
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {GURUGRAM_SERVICES.map((service) => (
            <div
              key={service.id}
