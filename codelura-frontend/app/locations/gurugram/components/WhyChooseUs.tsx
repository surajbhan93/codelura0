...
export default function WhyChooseUs() {
  const points = [
    ...
    },
    {
      ...
      title: "Dedicated Cyber City SLA & Support",
      desc: "Direct communication with senior tech architects, bi-weekly review demos, and priority SLAs for Gurugram clients."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl font-black text-white tracking-tight">
            Why Businesses in Gurugram Partner with Codelura Technologies
          </h2>
