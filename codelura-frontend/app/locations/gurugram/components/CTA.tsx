        ...
        <div className="bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border border-cyan-500/30 p-8 sm:p-12 rounded-3xl text-center space-y-6 relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-4 relative z-10">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
              Ready to Partner With Gurugram’s Premier Software &amp; IT Agency?
            </h2>
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              Whether you need enterprise SaaS software, custom mobile apps, or AEO/SEO/GEO search domination in Gurugram (Gurgaon), Codelura Technologies is ready to engineer your vision.
            </p>
          </div>
