...
export default function FAQ() {
  return (
    <section id="faqs" className="py-20 bg-slate-950 border-b border-slate-800/80">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Locations Hub FAQs</span>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white">
            Frequently Asked Questions (FAQs) - Codelura Location Hubs
          </h2>
          <p className="text-slate-400 text-base">
            Everything you need to know about our multi-city software development hubs, local engineering teams, regional market strategies, and project discovery across India.
          </p>
        </div>
