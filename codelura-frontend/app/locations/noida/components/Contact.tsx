    ...
    <section id="contact" className="py-20 bg-slate-900 border-b border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider">Start Your Noida Project</span>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white tracking-tight">
            Consult With Our Noida Software Engineering Team
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            {status === 'success' ? (
              <div className="p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl text-emerald-400 space-y-2 text-center">
                ...
                <p className="text-xs text-slate-300">
                  Thank you! Our Noida Solution Architect will review your specs and contact you within 2 to 4 business hours.
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-medium text-slate-300">Your Locality in Noida / Greater Noida</label>
                  <select
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-slate-950 border border-slate-800 p-6 rounded-3xl space-y-6">
              <h3 className="text-lg font-bold text-white">Noida Tech Hub Office</h3>
              ...
              <div className="space-y-4 text-xs text-slate-300">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <strong className="text-white block">Noida Engineering Desk:</strong>
