        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 border border-cyan-500/30 text-cyan-300 text-xs sm:text-sm font-medium shadow-sm">
              ...
              <span>Premier Software Engineering &amp; IT Hub in Noida (NCR)</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.12]">
              Top <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400">Software Development Company</span> in Noida
            </h1>

            <p className="text-base sm:text-lg text-slate-300 leading-relaxed font-normal">
              Empower your enterprise with <strong className="text-white">Next.js 15, React 19, Flutter, Python AI &amp; Cloud SaaS</strong> engineering. Codelura Technologies delivers high-performance custom software, mobile apps, e-commerce, and AEO/SEO/GEO search dominance for tech parks in <strong className="text-cyan-400">Sector 62, Sector 18, Sector 63, Greater Noida &amp; Noida Expressway</strong>.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              <a
                href={`https://wa.me/${COMPANY_DETAILS.whatsappPhone}?text=Hi%20Codelura,%20I%20want%20to%20discuss%20a%20software%20development%20project%20in%20Noida.`}
                target="_blank"
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-slate-800 bg-slate-900 p-2 shadow-2xl shadow-cyan-500/10">
              <Image
                src={images.hero}
                alt="Software Development Company in Noida - Codelura Technologies"
                width={800}
                height={600}
                priority
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-slate-950/90 backdrop-blur-md p-4 rounded-xl border border-slate-800/80">
                <div className="flex items-center justify-between text-xs">
                  <div>
                    <span className="text-white font-bold block">Noida Engineering Hub</span>
                    <span className="text-slate-400">Sector 62, Near Electronic City</span>
                  </div>
