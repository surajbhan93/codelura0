...
import { noidaSoftwareDevMetadata } from './metadata';
...
export const metadata: Metadata = noidaSoftwareDevMetadata;

export default function NoidaSoftwareDevelopmentPage() {
  const {
    organizationSchema,
    localBusinessSchema,
    serviceSchema,
    ...
    <main className="bg-slate-950 text-slate-100 font-sans min-h-screen selection:bg-cyan-500 selection:text-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 text-slate-300 leading-relaxed text-base sm:text-lg">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
              The Definitive Enterprise Software &amp; SaaS Blueprint for Companies in Noida
            </h2>
            <p className="text-slate-400">
              Modern enterprises require scalable software platforms engineered with clean microservices, cloud multi-tenancy, and high concurrency resilience. Whether you are building a custom ERP for industrial units in <strong className="text-white">Sector 63</strong>, a cloud SaaS product in <strong className="text-white">Sector 62 (Stellar IT Park)</strong>, or a corporate CRM on <strong className="text-white">Noida Expressway</strong>, Codelura Technologies delivers enterprise software engineered for sub-second speed, 99.99% cloud uptime, and 100% IP code ownership.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border border-cyan-500/30 p-8 rounded-3xl text-center space-y-4">
            <h4 className="text-xl sm:text-2xl font-bold text-white">Ready to Build Enterprise Software in Noida?</h4>
            <p className="text-sm text-slate-300 max-w-2xl mx-auto">
              Our Noida software engineering team will evaluate your business workflows, design your system architecture, and build a custom ERP, CRM, or SaaS platform.
            </p>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-10 text-slate-500 text-xs text-center space-y-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-400">
          <div>&copy; {new Date().getFullYear()} <strong className="text-white">Codelura Technologies</strong>. All rights reserved. Top Software Development Company in Noida &amp; Greater Noida.</div>
