...
export function generateSchemas() {
  ...
  const localBusinessSchema = {
    ...
    '@id': 'https://codelura.com/locations/noida/software-development/#localbusiness',
    name: `${COMPANY_DETAILS.name} - Software Development Company in Noida`,
    url: 'https://codelura.com/locations/noida/software-development',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'Enterprise Software & SaaS Development Services in Noida',
    provider: { '@type': 'LocalBusiness', name: COMPANY_DETAILS.name },
    areaServed: { '@type': 'City', name: 'Noida' },
    description: 'Custom Enterprise ERP, CRM software, multi-tenant SaaS engineering, business automation, and cloud microservices in Noida & Greater Noida.'
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'Software Development Company in Noida', item: 'https://codelura.com/locations/noida/software-development' }
    ]
  };
