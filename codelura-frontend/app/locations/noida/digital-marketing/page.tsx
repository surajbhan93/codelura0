...
import { noidaDigitalMarketingMetadata } from './metadata';
...
export const metadata: Metadata = noidaDigitalMarketingMetadata;

export default function NoidaDigitalMarketingPage() {
  const {
    organizationSchema,
    localBusinessSchema,
    serviceSchema,
    ...
    <main className="bg-slate-950 text-slate-100 font-sans min-h-screen selection:bg-cyan-500 selection:text-white">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 text-slate-300 leading-relaxed text-base sm:text-lg">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
              The Definitive Digital Marketing &amp; Lead Generation Guide for Noida Businesses
            </h2>
            <p className="text-slate-400">
              Generating qualified leads and high-ROAS sales requires a data-driven performance marketing strategy. Whether you operate a B2B SaaS enterprise in <strong className="text-white">Sector 62 or 63</strong>, a D2C retail brand in <strong className="text-white">Sector 18</strong>, or a real estate developer on <strong className="text-white">Noida Expressway</strong>, Codelura Technologies executes Google Ads (PPC), Meta Ads (FB/IG), WhatsApp automation, and Local SEO to maximize acquisition return.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-slate-900 via-cyan-950 to-slate-900 border border-cyan-500/30 p-8 rounded-3xl text-center space-y-4">
            <h4 className="text-xl sm:text-2xl font-bold text-white">Ready to Scale Leads &amp; Sales in Noida?</h4>
            <p className="text-sm text-slate-300 max-w-2xl mx-auto">
              Our Noida growth marketing team will audit your current PPC campaigns, ad accounts, and conversion funnels to deliver a high-ROAS performance plan.
            </p>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-10 text-slate-500 text-xs text-center space-y-4">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-400">
          <div>&copy; {new Date().getFullYear()} <strong className="text-white">Codelura Technologies</strong>. All rights reserved. Top Digital Marketing Agency in Noida &amp; Greater Noida.</div>
