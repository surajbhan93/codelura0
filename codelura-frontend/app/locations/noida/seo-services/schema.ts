...
export function generateSchemas() {
  ...
  const localBusinessSchema = {
    ...
    '@id': 'https://codelura.com/locations/noida/seo-services/#localbusiness',
    name: `${COMPANY_DETAILS.name} - SEO Company in Noida`,
    url: 'https://codelura.com/locations/noida/seo-services',
  ...
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    serviceType: 'SEO, AEO & GEO Search Engine Optimization Services in Noida',
    provider: { '@type': 'LocalBusiness', name: COMPANY_DETAILS.name },
    areaServed: { '@type': 'City', name: 'Noida' },
    description: 'Technical On-Page SEO, Off-Page Link Building, Local SEO Map 3-Pack, AEO (Voice Search), and GEO (Generative Engine Optimization) for ChatGPT/Perplexity AI search domination in Noida.'
  };
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: 'SEO Company in Noida', item: 'https://codelura.com/locations/noida/seo-services' }
    ]
  };
